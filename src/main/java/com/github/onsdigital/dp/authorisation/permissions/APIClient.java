    ...
    public Bundle getPermissionsBundle() throws BundleNotCached {
        ...
        try (CloseableHttpClient httpClient = httpClientSupplier.get();
            ...
            if (statusCode != STATUS_CODE_SUCCESS) {
                ...
                error().data(statusCodeTitle, statusCode).log(Messages.PERMISSIONS_API_FAILED_EXCEPTION);
                throw new Exception(String.format("%s: %d", Messages.PERMISSIONS_API_FAILED_EXCEPTION, statusCode));
